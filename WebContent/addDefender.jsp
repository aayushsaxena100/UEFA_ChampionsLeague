...
<body>
<form action = "defenderServlet" method ="get">
		...
		Player Tackles &nbsp;&nbsp;<input type="text" name="tackles"><br> 
		Player Interceptions &nbsp;&nbsp;<input type="text" name="interceptions"><br>
